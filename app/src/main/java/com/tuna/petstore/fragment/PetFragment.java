...
import com.tuna.petstore.activity.AboutActivity;
import com.tuna.petstore.adapter.PetAdapter;
import com.tuna.petstore.database.PetDAO;
import com.tuna.petstore.database.TypeDAO;
import com.tuna.petstore.inter.OnClick;
import com.tuna.petstore.model.Pet;
import com.tuna.petstore.model.TypePet;
...
//        getActivity().invalidateOptionsMenu();
    ...
    private void in() {
        if (typeDAO.getAllType().size() == 0) {
            ...
            typeDAO.insertType(new TypePet("t5", "Sóc"));
            typeDAO.insertType(new TypePet("t6", "Khác"));
        }
    }
